...
export async function renderModal(){
    ...
    await button.addEventListener("click",()=>{
        ...
        <div class="modal-background width-100 flex justify-content" id="modal-background"><div class="div-modal-form width-8 flex collum align-item">
            ...
            <form class="flex collum width-9 height-6">
                ...
                <textarea placeholder="Digite seu texto" class="input-text" rows="4" cols="50"></textarea>
...
async function criarModalEdit(arr){
    ...
    await modal.insertAdjacentHTML("afterend",`
        <div class="modal-background width-100 flex justify-content" id="modal-background"><div class="div-modal-form width-8 flex collum align-item">
            ...
            <form action="submit" class="flex collum width-9 height-6">
                <label for="">Título do post</label>
...
export function creatModalDelet(id){
    const modal = document.querySelector(".modal")
    modal.classList = "modal width-100 height-100"
    const section   = document.querySelector(`#s${id}`)
    modal.insertAdjacentHTML("afterbegin",`
        <div class="modal-background padding-space height-45 flex justify-content" id="modal-background">
        <div class="div-modal-form  height-65 width-60 flex collum align-item">
                ...
                <div class="div-access width-88 flex collum align-item">
                    <div class="flex align-item header-post space-between">
                        <div class="flex align-item">
                            ...
                            <span class="span">${element.user.username}</span>
                            <span class="span-date">${element.createdAt}</span>
                        </div>
